...
export function CodeTabs({ commands, className }: CodeTabsProps) {
    ...
    return (
        <div className={cn("w-full border border-border rounded-xl bg-card overflow-hidden shadow-lg", className)}>
            {/* Tab Header */}
            ...
            <div className="relative group bg-card p-4 min-h-[50px] flex items-center">
                <div className="absolute top-4 left-4 text-orange-500 opacity-50 select-none">
